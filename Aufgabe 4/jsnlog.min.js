...
typeof a?a instanceof RegExp?a.toString():a():a}function n(d){d=k(d);switch(typeof d){case "string":return new l(d,null,d);case "number":var c=d.toString();return new l(c,null,c);case "boolean":return c=d.toString(),new l(c,null,c);case "undefined":return new l("undefined",null,"undefined");case "object":if(d instanceof RegExp||d instanceof String||d instanceof Number||d instanceof Boolean)return c=d.toString(),new l(c,null,c);c="function"===typeof a.serialize?a.serialize.call(this,d):JSON.stringify(d);
    ...
    a.getTraceLevel();this.sendWithBufferLevel=2147483647;this.storeInBufferLevel=-2147483648;this.bufferSize=0;this.batchSize=1;this.buffer=[];this.batchBuffer=[]}d.prototype.setOptions=function(a){b("level",a,this);b("ipRegex",a,this);b("userAgentRegex",a,this);b("disallow",a,this);b("sendWithBufferLevel",a,this);b("storeInBufferLevel",a,this);b("bufferSize",a,this);b("batchSize",a,this);this.bufferSize<this.buffer.length&&(this.buffer.length=this.bufferSize);return this};d.prototype.log=function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        g,b,d,m,h,k){!e(this)||!f(this,h)||m<this.storeInBufferLevel||(a=new r(m,h,k,(new Date).getTime()),m<this.level?0<this.bufferSize&&(this.buffer.push(a),this.buffer.length>this.bufferSize&&this.buffer.shift()):(m<this.sendWithBufferLevel||!this.buffer.length||(this.batchBuffer=this.batchBuffer.concat(this.buffer),this.buffer.length=0),this.batchBuffer.push(a),this.batchBuffer.length>=this.batchSize&&this.sendBatch()))};d.prototype.sendBatch=function(){0==this.batchBuffer.length||null!=a.maxMessages&&
1>a.maxMessages||(null!=a.maxMessages&&(a.maxMessages-=this.batchBuffer.length),this.sendLogItems(this.batchBuffer),this.batchBuffer.length=0)};return d}();a.Appender=h;var p=function(d){function c(a){return d.call(this,a,c.prototype.sendLogItemsAjax)||this}__extends(c,d);c.prototype.setOptions=function(a){b("url",a,this);b("beforeSend",a,this);d.prototype.setOptions.call(this,a);return this};c.prototype.sendLogItemsAjax=function(c){try{var b="/jsnlog.logger";null!=a.defaultAjaxUrl&&(b=a.defaultAjaxUrl);
    this.url&&(b=this.url);var g=this.getXhr(b),d={r:a.requestId,lg:c};"function"===typeof this.beforeSend?this.beforeSend.call(this,g,d):"function"===typeof a.defaultBeforeSend&&a.defaultBeforeSend.call(this,g,d);var e=JSON.stringify(d);g.send(e)}catch(u){}};c.prototype.getXhr=function(c){var b=new XMLHttpRequest;if(!("withCredentials"in b)&&"undefined"!=typeof XDomainRequest)return b=new XDomainRequest,b.open("POST",c),b;b.open("POST",c);b.setRequestHeader("Content-Type","application/json");b.setRequestHeader("JSNLog-RequestId",
    a.requestId);return b};return c}(h);a.AjaxAppender=p;var q=function(b){function c(a){return b.call(this,a,c.prototype.sendLogItemsConsole)||this}__extends(c,b);c.prototype.clog=function(a){console.log(a)};c.prototype.cerror=function(a){console.error?console.error(a):this.clog(a)};c.prototype.cwarn=function(a){console.warn?console.warn(a):this.clog(a)};c.prototype.cinfo=function(a){console.info?console.info(a):this.clog(a)};c.prototype.cdebug=function(a){console.debug?console.debug(a):this.cinfo(a)};
    c.prototype.sendLogItemsConsole=function(c){try{if(console){var b;for(b=0;b<c.length;++b){var d=c[b],g=d.n+": "+d.m;"undefined"===typeof window&&(g=new Date(d.t)+" | "+g);d.l<=a.getDebugLevel()?this.cdebug(g):d.l<=a.getInfoLevel()?this.cinfo(g):d.l<=a.getWarnLevel()?this.cwarn(g):this.cerror(g)}}}catch(t){}};return c}(h);a.ConsoleAppender=q;h=function(){function a(a){this.loggerName=a;this.seenRegexes=[]}a.prototype.setOptions=function(a){b("level",a,this);b("userAgentRegex",a,this);b("disallow",
    a,this);b("ipRegex",a,this);b("appenders",a,this);b("onceOnly",a,this);this.seenRegexes=[];return this};a.prototype.buildExceptionObject=function(a){var b={};a.stack?b.stack=a.stack:b.e=a;a.message&&(b.message=a.message);a.name&&(b.name=a.name);a.data&&(b.data=a.data);a.inner&&(b.inner=this.buildExceptionObject(a.inner));return b};a.prototype.log=function(a,b,d){var c=0;if(!this.appenders)return this;if(a>=this.level&&e(this)&&(d?(c=this.buildExceptionObject(d),c.logData=k(b)):c=b,b=n(c),f(this,b.finalString))){if(this.onceOnly)for(c=
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  this.onceOnly.length-1;0<=c;){if((new RegExp(this.onceOnly[c])).test(b.finalString)){if(this.seenRegexes[c])return this;this.seenRegexes[c]=!0}c--}b.meta=b.meta||{};b.meta.loggerName=this.loggerName;for(c=this.appenders.length-1;0<=c;)this.appenders[c].log(1E3>=a?"trace":2E3>=a?"debug":3E3>=a?"info":4E3>=a?"warn":5E3>=a?"error":"fatal",b.msg,b.meta,function(){},a,b.finalString,this.loggerName),c--}return this};a.prototype.trace=function(a){return this.log(1E3,a)};a.prototype.debug=function(a){return this.log(2E3,
    a)};a.prototype.info=function(a){return this.log(3E3,a)};a.prototype.warn=function(a){return this.log(4E3,a)};a.prototype.error=function(a){return this.log(5E3,a)};a.prototype.fatal=function(a){return this.log(6E3,a)};a.prototype.fatalException=function(a,b){return this.log(6E3,a,b)};return a}();a.Logger=h;a.createAjaxAppender=function(a){return new p(a)};a.createConsoleAppender=function(a){return new q(a)};h=new p("");"undefined"===typeof window&&(h=new q(""));a.__=new a.Logger("");a.__.setOptions({level:a.getDebugLevel(),
 ...
 * Created by Basti on 23.05.2017.
 */
